...
describe("Tennis Score", () => {
  ...
  it("Deberia mostrar el marcador Love - 30 cuando el jugador 2 anota dos puntos", () => {
    const tennisScorer = new TennisScorer();
    tennisScorer.player2Scores();
    tennisScorer.player2Scores();
    expect(tennisScorer.showScore()).toEqual("Love - 30");
  });

  it("Deberia mostrar el marcador Love - 40 cuando el jugador 2 anota tres puntos", () => {
    const tennisScorer = new TennisScorer();
    tennisScorer.player2Scores();
    tennisScorer.player2Scores();
    tennisScorer.player2Scores();
  ...
  it("Deberia mostrar el marcador Advantage Player 1 cuando el jugador 1 anota un punto despues de Deuce", () => {
    const tennisScorer = new TennisScorer();
    tennisScorer.player1Scores();
    tennisScorer.player1Scores();
    tennisScorer.player1Scores();
